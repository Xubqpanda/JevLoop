...
- **Fixing the two `../docs/DESIGN-layers-2026-09-21.md` links in `AGENTS.md` by copying the target in.** Same reason. For anyone who clones only this repo those links are dead; when that file is next edited they should be dropped, not redirected to a stale copy.
